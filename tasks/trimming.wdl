    ...
    command <<<
        ...
        for R1 in ~{sep=" " fastq_files}; do
            ...
            if [ $CHECKREAD = "R1" ] ; then
                ...
                PAIRED_R1_OUT=trimmed_fastqs/${BASE}_R1_paired.fastq.gz
                UNPAIRED_R1_OUT=trimmed_fastqs/${BASE}_R1_unpaired.fastq.gz
                PAIRED_R2_OUT=trimmed_fastqs/${BASE}_R2_paired.fastq.gz
                UNPAIRED_R2_OUT=trimmed_fastqs/${BASE}_R2_unpaired.fastq.gz
